# Historical report: Telegram bot course implementation

> Preserved course evidence and historical test counts. Current bot behavior is
> documented in [`../telegram-bot.md`](../telegram-bot.md).
...
Пользователь пишет в Telegram-бота.<br>
Бот обрабатывает сообщение через aiogram handlers.<br>
Handlers используют `BackendClient`.<br>
...
Пользователь: Привет, меня зовут Диана<br>
Бот: Привет, Диана! Как я могу вам помочь?

Пользователь: Как меня зовут?<br>
Бот: Диана.
