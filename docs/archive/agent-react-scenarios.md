...
Для benchmark блока 6.3 единым исполняемым источником этих же пяти неизменённых
формулировок является `app/eval/agent_scenarios.py`; runner не парсит Markdown.
