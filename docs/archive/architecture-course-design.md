# Historical architecture exercise

> Course-era design evidence. Redis, LiteLLM and other future-state elements in
> this document are not part of the final production runtime. See
> [`../architecture.md`](../architecture.md) for the deployed architecture.
